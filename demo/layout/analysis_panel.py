...
def build_analysis_panel() -> dict:
    ...
    with gr.Column(scale=3, elem_classes=["right-column", "stretch-height"]):
        with gr.Tabs():
            ...
            with gr.TabItem("Target/Drug IC50 Correlation", elem_id="unified_ic50_correlation_tab"):
                ...
                corr_source_radio = gr.Radio(choices=["Internal Data (GDSC)", "External Data (DRH)"], value="Internal Data (GDSC)", show_label=False, elem_id="scatter_source_selector", visible=False)
            ...
            with gr.TabItem("Similar Drug Distribution", elem_id="drug_sim_dist_analysis_tab"):
                ...
                dist_source_radio = gr.Radio(choices=["Internal Data (GDSC)", "External Data (DRH)"], value="Internal Data (GDSC)", show_label=False, elem_id="drug_sim_source_selector", visible=False)
    ...
    return {
        "corr_source_radio": corr_source_radio, "corr_plot": corr_plot, "corr_controls": corr_controls,
        ...
        "dist_source_radio": dist_source_radio, "dist_plot": dist_plot, "dist_controls": dist_controls,
